...
- Frontend: `mspabitra918/oakhill-loans-frontend` (Next.js)
- Backend: `mspabitra918/oakhill-loans-backend` (NestJS serverless)
...
1. Vercel → **Add New → Project** → import `oakhill-loans-backend`.
...
## 2. Frontend (`oakhill-loans-frontend`)

Zero-config Next.js on Vercel.

1. Vercel → **Add New → Project** → import `oakhill-loans-frontend`.
